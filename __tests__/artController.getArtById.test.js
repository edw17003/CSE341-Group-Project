...
describe('Art Controller - getArtById', () => {
  ...
  const mockArt = {
    ...
    genre: 'Landscaping',  // Fixed typo in the genre
    image: 'someimage.jpeg',
  };

  // Reset the mock implementation before each test
  beforeEach(() => {
    Art.findOne.mockReset();
  });
  ...
  it('should get a single art by ID successfully', async () => {
    ...
    const artId = '655efff9f9c0c8ebaa184b4a';  // Replace with an existing artId
    const response = await request(app)
      .get(`/arts/${artId}`)  // Updated the path to match your actual route
